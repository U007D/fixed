...
";
                #[inline]
                #[must_use = "this returns the result of the operation, without modifying the original"]
                pub fn mul_add<const MUL_FRAC: u32>(
                    self,
                    mul: $Fixed<MUL_FRAC>,
                    add: $Fixed<FRAC>,
                ) -> $Fixed<FRAC>
...
";
                #[inline]
                pub fn inv_lerp<const RET_FRAC: u32>(
                    self,
                    start: $Fixed<FRAC>,
                    end: $Fixed<FRAC>,
                ) -> $Fixed<RET_FRAC>
...
";
                #[inline]
                #[must_use = "this returns the result of the operation, without modifying the original"]
                pub fn checked_mul_add<const MUL_FRAC: u32>(
                    self,
                    mul: $Fixed<MUL_FRAC>,
                    add: $Fixed<FRAC>,
                ) -> Option<$Fixed<FRAC>>
...
";
                #[inline]
                pub fn checked_inv_lerp<const RET_FRAC: u32>(
                    self,
                    start: $Fixed<FRAC>,
                    end: $Fixed<FRAC>,
                    ...
                    If<{RET_FRAC <= $nbits}>: True,
                {
                    ...
                    match inv_lerp::$Inner(self.to_bits(), start, end, RET_FRAC) {
...
";
                #[inline]
                #[must_use = "this returns the result of the operation, without modifying the original"]
                pub fn saturating_mul_add<const MUL_FRAC: u32>(
                    self,
                    mul: $Fixed<MUL_FRAC>,
                    add: $Fixed<FRAC>,
                ) -> $Fixed<FRAC>
...
";
                #[inline]
                pub fn saturating_inv_lerp<const RET_FRAC: u32>(
                    self,
                    start: $Fixed<FRAC>,
                    end: $Fixed<FRAC>,
                ) -> $Fixed<RET_FRAC>
                    ...
                    If<{RET_FRAC <= $nbits}>: True,
                {
                    ...
                    let start = start.to_bits();
                    let end = end.to_bits();
                    match inv_lerp::$Inner(self_bits, start, end, RET_FRAC) {
...
";
                #[inline]
                #[must_use = "this returns the result of the operation, without modifying the original"]
                pub fn wrapping_mul_add<const MUL_FRAC: u32>(
                    self,
                    mul: $Fixed<MUL_FRAC>,
                    add: $Fixed<FRAC>,
                ) -> $Fixed<FRAC>
...
";
                #[inline]
                pub fn wrapping_inv_lerp<const RET_FRAC: u32>(
                    self,
                    start: $Fixed<FRAC>,
                    end: $Fixed<FRAC>,
                ) -> $Fixed<RET_FRAC>
...
";
                ...
                #[track_caller]
                #[must_use = "this returns the result of the operation, without modifying the original"]
                pub fn unwrapped_mul_add<const MUL_FRAC: u32>(
                    self,
                    mul: $Fixed<MUL_FRAC>,
                    add: $Fixed<FRAC>,
                ) -> $Fixed<FRAC>
...
";
                #[inline]
                pub fn unwrapped_inv_lerp<const RET_FRAC: u32>(
                    self,
                    start: $Fixed<FRAC>,
                    end: $Fixed<FRAC>,
                ) -> $Fixed<RET_FRAC>
...
";
                #[inline]
                #[must_use = "this returns the result of the operation, without modifying the original"]
                pub fn overflowing_mul_add<const MUL_FRAC: u32>(
                    self,
                    mul: $Fixed<MUL_FRAC>,
                    add: $Fixed<FRAC>,
                ) -> ($Fixed<FRAC>, bool)
...
";
                #[inline]
                pub fn overflowing_inv_lerp<const RET_FRAC: u32>(
                    self,
                    start: $Fixed<FRAC>,
                    end: $Fixed<FRAC>,
                ) -> ($Fixed<RET_FRAC>, bool)
